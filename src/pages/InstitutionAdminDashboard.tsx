...
const ALL_SIDEBAR_ITEMS = [
  { title: 'Dashboard', icon: LayoutDashboard, path: '/admin/dashboard', roles: ['institution_admin','principal','hod','hr_manager','faculty','accountant','librarian','hostel_warden','transport_manager'] },
  { title: 'Approvals', icon: ShieldCheck, path: '/admin/approvals', roles: ['institution_admin','principal'] },
  { title: 'Academic Setup', icon: GraduationCap, path: '/admin/academic', roles: ['institution_admin','principal','hod'] },
  { title: 'Departments', icon: Building2, path: '/admin/departments', roles: ['institution_admin','principal','hod'] },
  { title: 'Students', icon: Users, path: '/admin/students', roles: ['institution_admin','principal','hod','faculty'] },
  { title: 'Staff', icon: UserCheck, path: '/admin/staff', roles: ['institution_admin','principal','hr_manager'] },
  { title: 'Timetable', icon: Calendar, path: '/admin/timetable', roles: ['institution_admin','principal','hod','faculty'] },
  { title: 'Attendance', icon: ClipboardCheck, path: '/admin/attendance', roles: ['institution_admin','principal','hod','faculty'] },
  { title: 'Examinations', icon: FileText, path: '/admin/examinations', roles: ['institution_admin','principal','hod','faculty'] },
  { title: 'Fees', icon: IndianRupee, path: '/admin/fees', roles: ['institution_admin','principal','accountant'] },
  ...
  { title: 'Settings', icon: Settings, path: '/admin/settings', roles: ['institution_admin','principal'] },
];

function getSidebarItems(role: string | null) {
  if (!role) return ALL_SIDEBAR_ITEMS;
  return ALL_SIDEBAR_ITEMS.filter(item => item.roles.includes(role));
}