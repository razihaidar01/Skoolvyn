  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        email: form.personal_email || form.official_email || form.email || null,
        ...
        salary: form.basic_salary ? parseFloat(form.basic_salary) : (form.salary ? parseFloat(form.salary) : null),
        bank_name: form.bank_name || null,
        bank_account_no: form.account_number || form.bank_account_no || null,
